...
\cvitem{Miscellaneous coursework}{\emph{} \newline Through the course of my degree I completed a number of team and individual assessments that required competence in a variety of skills and languages. Among others, examples include the development of a web server in C, Pacman game in python, web service in Javascript, and a distributed voice to text messenger in Java.}
...
\cventry{08/14-Present}{Software Engineer}{Singletrack}{London}{UK}{I am a software developer working on a cloud based content management system within
the finance sector. I work across the full-stack, developing software to facilitate the distribution and analysis of capital market research. This uses cloud technologies such as salesforce, Heroku, and Amazon web services. In addition I work on front end web services using ruby and javascript. I also work on data analysis using technologies such as python and pandas/numpy.}
