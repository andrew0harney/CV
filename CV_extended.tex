...
\cventry{08/15-Present}{Co-Founder and CTO}{Context Scout}{London}{UK}{I am the co-founder and CTO of Context Scout. Context Scout is a research-led software company developing new information retrieval and machine learning based approaches for web search, automated professional assistance, and task based information retrieval. My role involves the application of research in NLP, knowledge representation, and reasoning, and information retrieval for the development of commercial systems. I am lead on project and team management}

\cventry{08/14-08/15}{Software Engineer}{Singletrack}{London}{UK}{I was a software developer working on a cloud based content management system within the finance sector. My work focuses on developing software to allow the distribution of capital market research to interested parties. This uses cloud technologies such as salesforce, Heroku, and Amazon web services. In addition I work on front end services using ruby. Recent work has focused on introducing data driven and machine learning and NLP approaches to this challenge.}

\cventry{09/13--05/14}{Researcher/Developer}{Medical University of South Carolina}{South Carolina}{USA}{I was a researcher and software developer in the neurosciences department, under the supervision of Dr Thomas Naselaris. I developed tools that allow the lab to handle and process large amounts of data. In addition I developed machine learning models to explore the statistical properties of visual computation in the brain. Those models learned topic categorisations over large image collections, using techniques from information retrieval, and in particular, latent Dirichlet allocation. From this I predicted signals using regression methods. I also used engineering techniques for the analysis and filtering of signals. This was done using python with tools such as Pandas, Numpy and sklearn.}
...
\cvitem{Langauges}{Python [intermediate-advanced], Ruby [intermediate-advanced], Java [intermediate], Apex [intermediate], Matlab [intermediate], JS/JQuery [intermediate], C [basic-intermediate]}
\cvitem{Software Development}{Software development processes, Cloud, Version control, Team projects, Software patterns}
\cvitem{Analytic}{Artificial intelligence, Machine learning, Information retrieval}
